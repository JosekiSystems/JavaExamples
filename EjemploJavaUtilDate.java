...
public class EjemploJavaUtilDate {
    public static void main(String[] args) {
        ...
        SimpleDateFormat df5 = new SimpleDateFormat("yyyy.MM.dd G 'hora' HH:mm:ss z");
        SimpleDateFormat df6 = new SimpleDateFormat("EEEE dd 'de' MMMM 'del año' yyyy");
        ...
        System.out.println("tiempo que tarda el for = " + tiempoFinal);
